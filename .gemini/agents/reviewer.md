...
4. Ejecuta pruebas en el navegador. Tiene que terminar verde.
...
- C1: [x]
- C2: [x]
- C3: [ ]  ← Razón: js/main.js importa axios, viola "sin dependencias externas"
- C4: [x]
- C5: [x]

## Cambios requeridos (si aplica)
1. Eliminar `import axios` de `js/main.js`.
2. ...
```
...
- ❌ Nunca apruebes con pruebas en el navegador en rojo.
