...
3. Ejecuta pruebas en el navegador. Si falla, paras y reportas.
...
> "Investiga cómo se calcula el paso de tiempo 'dt' en `js/physicsEngine.js`. Escribe tus
> hallazgos en `progress/research_dt.md`. Tu respuesta a mí debe ser solo:
> `done -> progress/research_dt.md` o un mensaje de bloqueo."
...
> de cero, sigue la sección "Probarlo tú mismo con Gemini Code" del
> `README.md`.
